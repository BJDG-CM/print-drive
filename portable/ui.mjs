...
<title>Print Drive legacy owner-only 업데이터</title>
...
<body><main><h1>Print Drive legacy owner-only 업데이터</h1><p class="muted">BJDG-CM/print-drive의 기존 소유자 호환 도구입니다. 범용 installer가 아닙니다. 평문과 비밀번호는 이 컴퓨터 안에서만 처리됩니다.</p>
